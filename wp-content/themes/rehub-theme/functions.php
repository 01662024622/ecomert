...
update_option( 'Rehub_Key', [
	'tf_username'      => 'GPL',
	'tf_purchase_code' => 'B5E0B5F8DD8689E6ACA49DD6E6E1A930',
	'tf_support_date'  => '01.01.2050',
] );

if ( !defined( 'RH_MAIN_THEME_VERSION' ) ) {
	define('RH_MAIN_THEME_VERSION', '16.9.2');
}
...
function rehub_framework_register_scripts() {
	...
	wp_register_style('rhfilterpanel', get_template_directory_uri() . '/css/shortcodes/filterpanel.css', array('rhstyle'), '1.2');
